...
<div class="col-md-12 col-sm-12">
    ...
    <p class="text-center" style="color: gray;">Sản phẩm theo danh mục</p>
    @foreach($category as $item)
        @if($item['is_home']=='1')
        <div class="col-xl-4 col-lg-4">
            <div class="item-category">
                <a href="/product/{{$item['ctg_id']}}">
                    <img class="item-img" src="{{$item['image']}}" alt="" style="width: 100%;">
                </a>
                <br>
                <a class="item-title" href="/product/{{$item['ctg_id']}}">{{$item['name']}}</a>
                <br>
...
<div class="col-md-12 col-sm-12">
    ...
    <p class="text-center" style="color: gray;">Những sản phẩm mới</p>
...
<div class="col-md-12 col-sm-12">
    ...
    <p class="text-center" style="color: gray;">Các bài viết mới</p>
